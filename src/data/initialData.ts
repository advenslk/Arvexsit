...
export const INITIAL_GAMES: GameService[] = [
  { id: 'minecraft', name: 'Minecraft', slug: 'minecraft', category: 'Sandbox & Survival', startingPrice: 8.0, popular: true, image: 'https://www.image2url.com/r2/default/images/1788176922731-5e6dc6ce-f58f-40a6-bd49-f7d856157f42.jpeg', bannerImage: 'https://images.unsplash.com/photo-1542751371-adc38448a05e?auto=format&fit=crop&w=1200&q=80', activePlayers: '14,280 active servers', shortDescription: 'Full Spigot, Paper, Forge, Fabric, & Bedrock support with 1-click modpacks.', status: 'active' },
  { id: 'rust', name: 'Rust', slug: 'rust', category: 'Action & Survival', startingPrice: 12.0, popular: true, image: 'https://www.image2url.com/r2/default/images/1788177065616-8e2a9b66-a1be-468c-af47-537c7d14d24d.jpeg', bannerImage: 'https://images.unsplash.com/photo-1518709268805-4e9042af9f23?auto=format&fit=crop&w=1200&q=80', activePlayers: '8,430 active servers', shortDescription: 'Instant Oxide & uMod support, automated wipes, and high-tick rate hardware.', status: 'active' },
  { id: 'ark', name: 'ARK: Survival Ascended', slug: 'ark', category: 'Action & Survival', startingPrice: 14.0, popular: false, image: 'https://www.image2url.com/r2/default/images/1788177148040-ab495536-5171-4bfa-82c3-4a542fddbc77.jpeg', bannerImage: 'https://images.unsplash.com/photo-1579373903781-fd5c0c30c4cd?auto=format&fit=crop&w=1200&q=80', activePlayers: '4,190 active servers', shortDescription: 'Crossplay enabled, CurseForge mods, and automatic cluster syncing.', status: 'active' },
  { id: 'palworld', name: 'Palworld', slug: 'palworld', category: 'Open World RPG', startingPrice: 11.0, popular: true, image: 'https://www.image2url.com/r2/default/images/1788177228904-d65d4986-524a-431e-b610-fa2efdb4e228.jpeg', bannerImage: 'https://images.unsplash.com/photo-1509198397868-475647b2a1e5?auto=format&fit=crop&w=1200&q=80', activePlayers: '9,250 active servers', shortDescription: 'Memory leak prevention engine and ultra-fast NVMe processing.', status: 'active' },
  { id: 'cs2', name: 'Counter-Strike 2', slug: 'cs2', category: 'Competitive FPS', startingPrice: 9.0, popular: false, image: 'https://www.image2url.com/r2/default/images/1788177477225-8df3b495-aecc-4b92-9a0e-8bd9f6ee8623.jpeg', bannerImage: 'https://images.unsplash.com/photo-1511512578047-dfb367046420?auto=format&fit=crop&w=1200&q=80', activePlayers: '6,120 active servers', shortDescription: 'Sub-tick optimized 128-tick equivalent, fast token sync and SourceMod ready.', status: 'active' },
  { id: 'garrys-mod', name: "Garry's Mod", slug: 'garrys-mod', category: 'Sandbox', startingPrice: 7.5, popular: false, image: 'https://www.image2url.com/r2/default/images/1788177846756-8292f820-ced1-4d51-b4d0-45646c451cde.jpeg', bannerImage: 'https://images.unsplash.com/photo-1518709268805-4e9042af9f23?auto=format&fit=crop&w=1200&q=80', activePlayers: '5,800 active servers', shortDescription: 'FastDL integration, custom workshop collections, and DarkRP/TTT presets.', status: 'active' },
  { id: 'hytale', name: 'Hytale', slug: 'hytale', category: 'Upcoming RPG & Sandbox', startingPrice: 10.0, popular: true, image: 'https://www.image2url.com/r2/default/images/1788177746232-38ba44e9-42fb-41a6-ba7f-4ff168055d74.jpeg', bannerImage: 'https://images.unsplash.com/photo-1579546929518-9e396f3cc809?auto=format&fit=crop&w=1200&q=80', activePlayers: 'Pre-order available', shortDescription: 'Day-1 instant provisioning and priority cluster queuing reserved.', status: 'active' },
