...
// Specialized & Dynamic Route Pages
...
function MainWebsite() {
  ...
  const renderActivePage = () => {
    switch (currentPage) {
      // Dynamic Individual Detail Pages
      case 'dynamic-plan':
      ...
      case 'services-minecraft':
        return <MinecraftServicePage />;
      case 'services-games':
        return <GameHostingServicePage />;
      case 'services-vps':
        return <VpsServicePage />;
      case 'services-vds':
        return <VdsServicePage />;
      case 'services-web-hosting':
        return <WebHostingServicePage />;
      case 'services-bot-hosting':
        return <BotHostingServicePage />;

      // Commercial & Flow Pages
      case 'plans':
      case 'pricing':
        return <PricingPage />;
      case 'games':
